...
#compile MPI
CC99='mpicc -std=c99' qcc -g -Wall -grid=quadtree -O2 -D_MPI=1 -DMTRACE=0 drop.c -o drop -I$BASILISK -L$BASILISK/gl -lglutils -lfb_osmesa -lGLU -lOSMesa -I$GSL -lgsl -lgslcblas -L$GSL  -lm
