...
#compile mpi
#CC99='mpicc -std=c99' qcc -Wall -grid=quadtree -O2 -D_MPI=1 drop-Skele.c -o _drop -I$BASILISK -L$BASILISK/gl -lglutils -lfb_osmesa -lGLU -lOSMesa -I$GSL -lgsl -lgslcblas -L$GSL  -lm
