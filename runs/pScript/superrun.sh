...
#smooth vs vof
#mpiexec -n 1 -machinefile $PBS_NODEFILE python3 vofsmooth.py
#mpiexec -n 1 -machinefile $PBS_NODEFILE ffmpeg -r 4 -y -threads 4 -i 2DEvolve/svofplt-%03d.png -pix_fmt yuv420p -vf scale=-1:720 2DEvolve.mp4
echo
