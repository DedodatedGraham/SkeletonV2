...
def plotmirror(sdat,idat,mirroraxi,mirrorval,save,t,focus):
    ...
    if mirroraxi == 0:
        plt.scatter(idat[0],idat[1],c=idat[4],cmap='rainbow',s=5,vmin=vmin,vmax=vmax)
        p = plt.scatter(sdat[0],sdat[1],c=sdat[3],cmap='rainbow',s=5,vmin=vmin,vmax=vmax)
        plt.colorbar(p)
...
if __name__ == '__main__':
    ...
    while(case):
        ...
        iny = []
        col = []
        spath = source + r'basiliskRuns/' + "smoothskeleton-{:.3f}.dat".format(t)
